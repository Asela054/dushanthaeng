            ...
            <div class="container-fluid">
                <div class="page-header-content py-3 px-2">
                    <h1 class="page-header-title ">
                        ...
                        <span>Functional Parameter</span>
                    </h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-row mb-1">
                                    <div class="col-12">
                                        <label class="small font-weight-bold text-dark">Functional KPI*</label>
                                ...
                                <div class="form-row mb-1">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="parameter" name="parameter" class="form-control form-control-sm"
                                            required>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#dataTable').DataTable({
            ...
            ajax: {
                "url": "{!! route('functionalparameterlist') !!}",
        ...
        $('#create_record').click(function () {
            $('.modal-title').text('Add New Functional Parameter');
        ...
        $('#formTitle').on('submit', function(event){
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('functionalparameterinsert') }}";
                }
                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('functionalparameterupdate') }}";
                }
            ...
            $(document).on('click', '.edit', async function () {
                ...
                if (r == true) {
                        ...
                        $.ajax({
                            url: '{!! route("functionalparameteredit") !!}',
                                type: 'POST',
                                dataType: "json",
                                data: {id: id },
                            success: function (data) {
                                $('#type').val(data.result.type_id);
                                $('#kpi').val(data.result.kpi_id);
                                $('#parameter').val(data.result.parameter);
                                $('#hidden_id').val(id);
                                $('.modal-title').text('Edit Functional Parameter');
        ...
        $(document).on('click', '.delete', async function () {
                ...
                if (r == true) {
                    ...
                    $.ajax({
                        url: '{!! route("functionalparameterdelete") !!}',
                        type: 'POST',
                        dataType: "json",
                        data: { id: user_id },
                        beforeSend: function () {
    ...
    if (type !== '') {
        $.ajax({
            url: '{!! route("functionalparametergetkpifilter", ["type_id" => "type_id"]) !!}'
