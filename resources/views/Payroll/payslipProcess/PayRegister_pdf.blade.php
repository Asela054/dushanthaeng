        	...
        	<table width="100%" border="0" cellpadding="2" cellspacing="0" class="pdf_data">
                <thead>
                    <tr class="col_border">
                        ...
                        <th style="text-align:center;">Attendance Allw.</th>
                        <th class="" style="text-align:center;">Transport Allowance</th>
                        <th style="text-align:center;">Perf. Based Insentive</th>
                        <th style="text-align:center;">Other Allowance</th>
                        <th style="text-align:center;">Other Additions</th>
                ...
                @foreach ($emp_array as $row)
                    ...
                    <tr class="col_border">
                        ...
                        <td>{{ number_format((float)$row['ATTBONUS'], 2, '.', ',') }}</td>
                        ...
                        <td>{{ number_format((float)($row['add_other']+$row['ATTBONUS_W']), 2, '.', ',') }}</td>
