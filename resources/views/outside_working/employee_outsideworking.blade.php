        ...
        <div class="container-fluid">
            <div class="page-header-content py-3 px-2">
                <h1 class="page-header-title ">
                    ...
                    <span>Employee Outside Working</span>
                </h1>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-2 p-0 p-2">
        <div class="card">
            <div class="card-body p-0 p-2">
                <div class="row">
                    <div class="col-12">
                        <button type="button" class="btn btn-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Employee Outside Working</button>
                    </div>
                    <div class="col-12">
        ...
        <div class="modal-dialog modal-dialog-centered model-sm">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Employee Outside Working</h5>
...
$(document).ready(function(){
    ...
    $('#outsideworking').addClass('navbtnactive');
    ...
    $('#dataTable').DataTable({
        ...
        "buttons": [{
                ...
                title: 'Outside Working Information',
        ...
        ajax: {
            url: scripturl + "/workingoutsidelist.php",
            type: "POST",
            data: {},
        },
        columns: [{
    ...
    $('#formTitle').on('submit', function(event){
        ...
        if ($('#action').val() == 'Add') {
            action_url = "{{ route('outsideworkinginsert') }}";
        }
        if ($('#action').val() == 'Edit') {
            action_url = "{{ route('outsideworkingupdate') }}";
        }
        ...
        if (r == true) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#hidden_id').val(id);
                    $('.modal-title').text('Edit Employee Outside Working');
    ...
    $(document).on('click', '.delete', async function() {
        ...
        if (r == true) {
            ...
            $.ajax({
                url: "outsideworking/destroy/" + user_id,
                beforeSend: function () {
