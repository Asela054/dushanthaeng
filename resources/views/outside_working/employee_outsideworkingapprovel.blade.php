        ...
        <div class="container-fluid">
            <div class="page-header-content py-3 px-2">
                <h1 class="page-header-title ">
                    ...
                    <span>Outside Working Approvel</span>
                </h1>
            </div>
        </div>
    </div>  
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Approve Outside Working</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal" id="formApprove">
                                <div class="form-group mb-1">
                                    <div class="col-12">
                                         <label class="small font-weight-bolder text-dark">Remunition Type</label>
...
$(document).ready(function () {
    ...
    $('#formFilter').on('submit',function(e) {
        ...
        $.ajax({
                url: "{{url('/generateoutsideworkingallowance')}}",
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                        ...
                        responsive: true,
                         dom: "<'row'<'col-sm-4 mb-sm-0 mb-2'B><'col-sm-2'l><'col-sm-6'f>>" + "<'row'<'col-sm-12'tr>>" +
                            ...
                            "buttons": [{
                                    ...
                                    title: 'Outside Working Approval Information',
                  ...
                  $('#btn-approve').on('click', function (e) {
                      ...
                      if (remunitiontype == '') {
                          ...
                          if (selectedRowIdsapprove.length > 0) {
                              ...
                              $.ajax({
                                  url: '{!! route("approveoutsideworkingallowance") !!}',
                                  type: 'POST',
                                  dataType: "json",
                                  data: {
