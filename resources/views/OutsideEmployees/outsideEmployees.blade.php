            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header p-2">
                        <h5 class="modal-title" id="staticBackdropLabel">Add Outside Employee</h5>
...
$(document).ready(function () {
    ...
    $('#outsideemployees').addClass('navbtnactive');
    ...
    function load_dt(company, department, employee, location) {
        $('#dataTable').DataTable({
            ...
            "buttons": [{
                    ...
                    title: 'Outside Employee Information',
            ...
            ajax: {
                url: scripturl + '/OutsideEmployees/outside_employee_list.php',
                type: "POST",
                data: {
                    company: company,
    ...
    $('#create_record').click(function(){
        $('.modal-title').text('Add Outside Employee');
    ...
    $('#formTitle').on('submit', function(event){
        ...
        if ($('#action').val() == 'Add') {
            action_url = "{{ route('addOutsideEmployee') }}";
        }
        if ($('#action').val() == 'Edit') {
            action_url = "{{ route('OutsideEmployee.update') }}";
        }
    ...
    $(document).on('click', '.edit', async function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#hidden_id').val(id);
                $('.modal-title').text('Edit Outside Employee');
    ...
    $(document).on('click', '.delete', async function () {
        ...
        if (r == true) {
            ...
            $.ajax({
                url: "{{ url('OutsideEmployee/destroy/') }}/" + user_id,
                beforeSend: function () {
