...
$columns = array(
	...
	array( 'db' => '`u`.`sno`', 'dt' => 'sno', 'field' => 'sno' ),
	array( 'db' => '`u`.`emi`', 'dt' => 'emi', 'field' => 'emi' ),
	array( 'db' => '`u`.`conection_no`', 'dt' => 'conection_no', 'field' => 'conection_no' ),
...
$joinQuery = "FROM `fingerprint_devices` AS `u`
